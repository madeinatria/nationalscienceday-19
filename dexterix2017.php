  ...
  <?php include('navbar.php') ; ?>
   	<div class="site-header">
		<div class="main-navigation">
			...
			<li><a class="show-2 templatemo_page2" href="#">What people say</a></li>
			...
			<div class="container">
				<div class="row templatemo_gallerygap">
                    ...
                    <div class="col-md-3 col-sm-12">
                    	<h1 style="font-size:40px">DEXTERIX 2K17</h1>
                    </div>
            	...
            	<div class="row">
                	<div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(images/cse/cse-techsay.jpg);">
                                ...
                                <div class="clear"></div>
                               	<div class="overlay templatemo_overlaytxt">Techsay</div>
                                </div>
                            </div>
                          </div>
  			       </div>
                    <div class="col-md-3 col-sm-8 templatemo_servicetxt" >
                    	<h2>TECH SAY</h2>
                        <p style="font-size:18px" >Giving a Tech Talk — How to Have Fun and Not Die. </p>
                         <p style="font-size:15px" >Encourages students to overcome stage fear and deliver.</p>
                    ...
                    <div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(images/cse/cse-cc.jpg);">
                                <div class="overlay templatemo_overlay1">
                                
                                </div>
                                
                                <div class="clear"></div>
                               	<div class="overlay templatemo_overlaytxt">CODESENSE</div>
                                </div>
                            </div>
                          </div>
  			       </div>
                    <div class="col-md-3 col-sm-8 templatemo_servicetxt">
                    	<h2>CODESENSE</h2>
                        <p style="font-size:18px">Hey! It compiles! Ship it!</p>
                        <p style="font-size:15px" >Gave students a platform to display their coding skills.</p>
                    </div>
                    </div>
               </div>
            </div>
            ...
            <div class="container templatemo_hexteam s_top">
            	<div class="row">
                	<div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(images/ece/ece-circuit.jpeg);">
                                <div class="overlay templatemo_overlay1">
                                	
                                </div>
                                
                                <div class="clear"></div>
                               	<div class="overlay templatemo_overlaytxt">Circuitrix</div>
                                </div>
                            </div>
                          </div>
  			       </div>
                    <div class="col-md-3 col-sm-8 templatemo_servicetxt" >
                    	<h2>CIRCUITRIX</h2>
                        <p style="font-size:18px" >No resistance can drop our potential !</p>
                         <p style="font-size:15px" >Allowed students to brag about and display their circuit building talent.</p>
                    ...
                    <div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(images/makeathon.jpeg);">
                                <div class="overlay templatemo_overlay1">
                                	<a href="#fb">
                                ...
                                <div class="clear"></div>
                               	<div class="overlay templatemo_overlaytxt">Makeathon</div>
                                </div>
                            </div>
                          </div>
  			       </div>
                    <div class="col-md-3 col-sm-8 templatemo_servicetxt">
                    	<h2>MAKEATHON</h2>
                        <p style="font-size:18px">Make, create and have fun!</p>
                    </div>
                    </div>
               </div>
            </div>
