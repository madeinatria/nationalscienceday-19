      ...
      <div  id="particles">
         <div  id="intro"   style=" margin-top: 0px!important;">
            <div class="fade-in one"  >
               <h1 style="font-weight:500!important; display:inline-block;  font-size: 70px;color:#f5f5f5"><div style=" border: 3px solid white;background:rgba(0,0,0,0.7);">National Science Day '19</div></h1>
               <p style="font-size:20px" >February 27th | February 28th</p>
